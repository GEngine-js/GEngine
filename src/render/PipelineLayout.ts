...
export class PipelineLayout {
  ...
  index:number;
  private constructor(device:GPUDevice,label:string,public groupLayouts: BindGroupLayout[] = [],index?:number) {
    this.index=index||0
  ...
  static getPipelineLayoutFromCache(device:GPUDevice,label:string,groupLayouts:BindGroupLayout[] ):PipelineLayout{
