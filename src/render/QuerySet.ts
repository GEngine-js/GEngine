...
export default class QuerySet {
    ...
    constructor(public device: GPUDevice, public querySetDescriptor: GPUQuerySetDescriptor) {
        ...
        this.readBuffer=Buffer.create(this.device, GPUBufferUsage.COPY_DST | GPUBufferUsage.COPY_SRC, null, this.querySetDescriptor.count * 8)
    }
    private async getReadBuffer() {
        ...
        commandEncoder.copyBufferToBuffer(this.queryBuffer.gpuBuffer , 0,this.readBuffer.gpuBuffer,0 ,8*this.nextQueryIndex[0]);
