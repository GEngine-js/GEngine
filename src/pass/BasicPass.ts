...
export class BasicPass extends Pass {
	...
	render(frameState: FrameState, camera?: Camera) {
		...
		renderQueue.opaqueRender(camera, this.context, this.passRenderEncoder, lightManger, PassEnum.RENDER);
		renderQueue.transparentRender(camera, this.context, this.passRenderEncoder, lightManger, PassEnum.RENDER);
